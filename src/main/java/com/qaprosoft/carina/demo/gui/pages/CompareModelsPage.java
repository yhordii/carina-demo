...
public class CompareModelsPage extends AbstractPage {
    ...
    private List<CondidateBlock> candidateBlock;
    ...
    public List<ModelSpecs> compareModels(String... models) {
        ...
        for (int index = 0; index < models.length; index++) {
            ...
            condidateBlock = candidateBlock.get(index);
    ...
    public List<ModelSpecs> compareSelectedModels(){
        List<ModelSpecs> modelSpecs = new ArrayList<>();
        ModelSpecs modelSpec = null;
