...
public class PhoneFinderMenu extends AbstractUIObject {
    ...
    public PhoneFinderPage openPhoneBrand(PhoneBrands phoneBrands) {
        phoneBrand = findExtendedWebElement(By.xpath(String.format("//div[@class='brandmenu-v2 light l-box clearfix']/ul/li/a[contains(text(),'%s')]", phoneBrands.getValue())));
        phoneBrand.click();
        return new PhoneFinderPage(driver);
    }
}
